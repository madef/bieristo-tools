...
class View {
  ...
  getList () {
    return [
      ...
      },
      {
        ...
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" class="w-full h-auto aspect-square rounded bg-amber-500 group-hover:text-amber-500 group-hover:bg-transparent group-focus:text-amber-500 group-focus:bg-transparent" aria-hidden="true">
  ...
  viewBox="0 0 260 260" enable-background="new 0 0 260 260" xml:space="preserve"  class="w-full h-auto aspect-square p-2 rounded bg-amber-500 group-hover:text-amber-500 group-hover:bg-transparent group-focus:text-amber-500 group-focus:bg-transparent" aria-hidden="true">
...
<path d="M186.662,212.515l-52.247-52.247l25.853-25.853l52.247,52.247l0.101,25.954L186.662,212.515z M258,243.369l-21.847-21.847
  ...
  <path d="M5.5 2.5a2.5 2.5 0 0 1 5 0v7.55a3.5 3.5 0 1 1-5 0zM8 1a1.5 1.5 0 0 0-1.5 1.5v7.987l-.167.15a2.5 2.5 0 1 0 3.333 0l-.166-.15V2.5A1.5 1.5 0 0 0 8 1"/>
      ...
      }/*,
      {
        ...
        icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-full h-auto aspect-square rounded bg-amber-500 group-hover:text-amber-500 group-hover:bg-transparent group-focus:text-amber-500 group-focus:bg-transparent" aria-hidden="true">
  ...
  getEntry (view) {
    ...
    for (const viewEntry of this.getList()) {
      if (viewEntry.key === view) {
        return viewEntry
      }
    }
  }
  ...
  getSubview (view) {
    ...
    if (typeof viewEntry.children === 'undefined') {
      return null
    }

    for (const subviewEntry of viewEntry.children) {
      if (subviewEntry.key === subview) {
        return subview
      }
    }

    return viewEntry.children[0].key
  }
