  ...
  constructor ($root) {
    ...
    this.layout = new Brique(`
      <div class="flex flex-col inset-0 bg-main text-white h-svh">
        <div class="flex overflow-auto justify-start items-start gap-1.5 md:gap-2 p-2 shrink-0" data-var="menu">
        </div>
        <div class="flex overflow-auto justify-start items-start gap-1.5 md:gap-2 px-2 pb-2 shrink-0" data-var="submenu">
        </div>
        <div class="grow overflow-y-auto" data-var="content"></div>
        <div class="grow overflow-y-auto hidden" data-var="alt-content"></div>
