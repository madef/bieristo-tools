    ...
    this.view = new Brique(`<div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-2 pt-4">
          <div class="flex justify-end gap-2">
            <button class="bg-cyan-700 hover:bg-transparent hover:text-cyan-700 focus:bg-transparent focus:text-cyan-700 rounded flex gap-2 items-center p-2" data-var="download">
